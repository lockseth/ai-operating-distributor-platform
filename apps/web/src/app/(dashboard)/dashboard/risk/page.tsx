...
interface UnifiedRiskAlert {
  category: "Sales Risk" | "Collection Risk" | "Behavior Change" | "Transaction Risk";
...
export default async function RiskPage() {
  ...
  const [discountAnomalyReport, collectionRiskReport, behaviorChangeReport, transactionRiskReport] = await Promise.all([
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3">
        <p className="text-sm font-medium text-emerald-800">
          Business Guard AI — 4 fitur aktif (Sales Risk, Collection Risk, Behavior Change, Transaction Risk Score)
        </p>
