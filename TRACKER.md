...
| **Business Guard AI** (Risk Alert) | **2 slice hidup** — Sales Risk/Discount Anomaly (2026-08-14) + Collection Risk/piutang macet (2026-08-18, juga dikontribusikan ke Executive Intelligence). Sisanya (Behavior Change, Risk Alert List umum, Transaction Risk Score) masih "Segera Hadir" | `apps/web/src/lib/business-guard/`, `apps/web/src/app/(dashboard)/dashboard/risk/page.tsx`, `apps/web/src/lib/executive/contributors/business-guard.ts` |
