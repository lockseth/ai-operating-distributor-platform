...
| **Business Guard AI** (Risk Alert) | **2 slice hidup, keduanya dikontribusikan ke Executive Intelligence** — Sales Risk/Discount Anomaly (2026-08-14, wiring ke dashboard Owner 2026-08-18) + Collection Risk/piutang macet (2026-08-18). Sisanya (Behavior Change, Risk Alert List umum, Transaction Risk Score) masih "Segera Hadir" | `apps/web/src/lib/business-guard/`, `apps/web/src/app/(dashboard)/dashboard/risk/page.tsx`, `apps/web/src/lib/executive/contributors/business-guard.ts` |
