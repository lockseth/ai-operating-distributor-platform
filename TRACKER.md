...
**KOSONG.** Fondasi data chatbot bisnis Owner selesai — lihat Log
Milestone.
...
9. **[TEMUAN 2026-08-19]** Audit arsitektur lengkap "event AODP → WhatsApp" — mengoreksi klaim lama "tinggal daftarkan `n8n_webhooks`, tidak perlu kode baru". Ternyata ada **2 pipeline terpisah**, keduanya belum siap kirim WA nyata meski kredensial Bablast sudah di tangan:
   ...
   Rekomendasi CTO: 3 pekerjaan terpisah kalau mau WA beneran nyala — (1) menu "Tambah Webhook" di halaman Automation (UI, ready dikerjakan kapan saja), (2) workflow n8n nyata ke Bablast (butuh kredensial dulu), (3) hapus hardcode dry-run Jalur B (kode, bisa dikerjakan kapan saja tapi baru ada gunanya setelah (2) beres).
