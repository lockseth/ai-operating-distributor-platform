...
`/api/internal/automation/sales-report-afternoon`, dan
...
| `aodp-collection-plan-morning.json` | Cron 07:30 Asia/Jakarta, hari kerja (Sen-Jum) | Generate Rencana Penagihan Owner -- "toko yang mau ditagih" hari itu: overdue H+1 dan/atau janji bayar H+1 (structured preview, WhatsApp dry-run). Gate P4.12, Fase B varian PAGI |
...
`automation.collection_plan.generate`.
...
+ cron expression `0 7 * * *`/`30 7 * * 1-5`/`0 8 * * *`/`30 16 * * 1-5` WIB).
